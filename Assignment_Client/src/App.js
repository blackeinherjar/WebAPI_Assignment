// https://mighty-anchorage-39322.herokuapp.com/
...
class App extends Component {
  ...
  getAllCharacters = () => {
    axios
      .get('https://powerful-reef-62967.herokuapp.com/getallcharacters')
      .then(result => {
  ...
  onSubmit = e => {
    ...
    const query = `https://powerful-reef-62967.herokuapp.com/addCharacter?name=${
      this.state.name
    }`;
  ...
  removeCharacter(my_id) {
    ...
    const query = `https://powerful-reef-62967.herokuapp.com/deletecharacter?my_id=${my_id}`;
